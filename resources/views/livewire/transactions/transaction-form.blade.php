<div>
    @if ($showModal)
        <div class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            {{-- Modal --}}
            <div
                class="relative w-full max-w-lg mb-20 sm:mb-0
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select wire:model="wallet_id" class="mt-1 w-full rounded-xl border-slate-200 text-sm">
                        ...
                        <div>
                            ...
                            <select wire:model="category_id" class="mt-1 w-full rounded-xl border-slate-200 text-sm">
